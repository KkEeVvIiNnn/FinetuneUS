...
deepspeed --num_gpus=8 ./src/train.py \
    ...
    --max_review_len 50 \
    --itemnum 36659 \
    --rec_model_load_state_dict "./baselines/SASRec/outputs/Books-Movies_and_TV/l=2_h=1_d=50_lr=0.001/model.bin" \
    --prefix_length 3 \
    ...
    --output_dir ./output/GeneratePrompt_tr_p3_lora/Books \
    ...
    --print_loss \
    --deepspeed > GP_tr_p3_lora_all_Books.log