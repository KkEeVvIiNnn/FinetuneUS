...
deepspeed ./src/train.py \
    ...
    --lora_dim 8 \
    --data_dir ./data \
    --rec_model_load_state_dict "./baselines/text_bert/outputs/Movies_and_TV-Books/l=2_h=1_d=50_lr=0.001/model.bin" \
    ...
    --output_dir ./output/GeneratePrompt/Movies_and_TV \
